...
class ViewController: UIViewController {
    ...
    override func viewDidDisappear (_ animated: Bool) {
        UserData.shared.userId = 000001
        UserData.shared.token = "444KnvOewf312Poefff23"
        UserData.shared.userName = loginInput.text
    }
   ...
   /*override func shouldPerformSegue(withIdentifier identifier: String, sender: Any?) -> Bool {
    ...
    func enterVKScreen () {
        let controller = UIStoryboard.init(name: "Main", bundle: nil).instantiateViewController(identifier: "enterVK")
