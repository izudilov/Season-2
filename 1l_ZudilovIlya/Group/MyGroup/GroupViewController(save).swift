...
class GroupViewController: ASDKViewController<ASDisplayNode>, ASTableDelegate, ASTableDataSource, CAAnimationDelegate {
    ...
    func tableNode(_ tableNode: ASTableNode, nodeBlockForRowAt indexPath: IndexPath) -> ASCellNodeBlock {
        ...
        let cellNodeBlock = { () -> ASCellNode in
            let node = GroupViewCell (source: self.groupsFromVK )
        return node
            }
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
            //photoService = PhotoService.init(container: tableNode)
