...
class UserViewController: UITableViewController {
    ...
    var sections = [GroupedSection <Character, UserModel>]()
    
    private let factory = UserFactory()
    private var viewModels: [UserModel] = []
    ...
    override func viewDidLoad() {
        ...
        do {
            ...
            self.friendsFromVK = self.factory.constructViewModels(from: Array(usersFromRealm))
...
// если произошла ошибка, выводим ее в консоль
       ...
       // self.navigationItem.rightBarButtonItem = self.editButtonItem
        ...
        self.sections = GroupedSection.group(rows: friendsFromVK,  by: { letter(character: $0.userLastName) })
...
// MARK: - Table view data source
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
           ...
           // Устанавливаем userName and Foto в надпись ячейки
            ...
            sub2.layer.shadowColor = VKFlyWeight.shadowColor.cgColor
            ...
            if isFiltering {
                friends = friendsFromVK[indexPath.row]
                user.userName.text = friends.userFullName
                imageFoto = try? UIImage(data: Data(contentsOf: (URL(string: friends.userPhoto) ?? URL(string: "https://vk.com/images/camera_100.png"))!))
                ...
                user.userName.text = headline.userFullName
                //imageFoto = UIImage(named: headline.photo_100)
                imageFoto = try? UIImage(data: Data(contentsOf: (URL(string: headline.userPhoto) ?? URL(string: "https://vk.com/images/camera_100.png"))!))
...
extension UserViewController: UISearchResultsUpdating {
    ...
    private func filterContentForSearchText (_ searchText: String) {
        ...
        filteredFriends = FriendsVK.friends.filter({ (friends: UserModel) -> Bool in
            return friends.userLastName.lowercased().contains(searchText.lowercased())
        })
